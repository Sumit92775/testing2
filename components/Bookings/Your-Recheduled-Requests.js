                ...
                if(res.status){
                    ...
                    // console.log("UserRescheduleBookingArray: ",userRescheduledBookingsArray);
                        ...
                        for(let i = 0; i < userRescheduleArray.length; i++) {
                            ...
                            setBookingAddress(userRescheduleArray[i].Booking.Variation.Service.Store.Addresses);

                            let address = "";

                            address+=userRescheduleArray[i].Booking.Variation.Service.Store.Addresses[0].add1+", ";
                            address+=userRescheduleArray[i].Booking.Variation.Service.Store.Addresses[0].add2+", "
                            address+=userRescheduleArray[i].Booking.Variation.Service.Store.Addresses[0].city+", "
                            address+=userRescheduleArray[i].Booking.Variation.Service.Store.Addresses[0].zipCode;
                            ...
                            dataSource.push({
                                ...
                                spname: {spname: userRescheduleArray[i].Booking.Variation.Service.Store.storeName, address: address},
                                olddateandtime: userRescheduleArray[i].OldTime,
                                newdateandtime: userRescheduleArray[i].newTime,
                                service: {service: userRescheduleArray[i].Booking.Variation.Service.primaryServiceName, variant: userRescheduleArray[i].Booking.Variation.primaryLanguageVariationName , type: serviceType},
